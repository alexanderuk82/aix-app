...
export interface ApiAnalysisAnalysis extends Schema.CollectionType {
...
export interface ApiInterviewInterview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    company: Attribute.Relation<
      ...
      'api::company.company'
    >;
    textInterview: Attribute.Text;
    Interviewed: Attribute.String;
    product: Attribute.String;
    idInterview: Attribute.UID<'api::interview.interview', 'title'>;
    uxAnalysis: Attribute.JSON;
    user_name: Attribute.Relation<
      'api::interview.interview',
      'manyToOne',
      'api::user-name.user-name'
...
export interface ApiUxAnalysisUxAnalysis extends Schema.CollectionType {
  collectionName: 'ux_analyses';
  info: {
    singularName: 'ux-analysis';
    pluralName: 'ux-analyses';
    displayName: 'UXAnalysis';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-name.user-name': ApiUserNameUserName;
      'api::ux-analysis.ux-analysis': ApiUxAnalysisUxAnalysis;
    }
  }
}
